...
_C.data.label_root = osp.join(_C.root_dir, 'data', 'Kitti','label')
...
_C.model.num_points_in_raw = 128
...
_C.geotransformer.blocks = ['label_self', 'label_cross', 'label_self', 'label_cross', 'label_self', 'label_cross']
_C.geotransformer.sigma_d = 4.8
_C.geotransformer.sigma_a = 15
_C.geotransformer.angle_k = 3
_C.geotransformer.reduction_a = 'max'
_C.geotransformer.in_pro_2 = 21

# model - Fine Matching
_C.fine_matching = edict()
_C.fine_matching.topk = 6
