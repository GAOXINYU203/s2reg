...
class Trainer(EpochBasedTrainer):
    def __init__(self, cfg):
        ...
        #         self.logger.info("=> loading weight '{}'".format(cfg.weight))
        #         checkpoint = torch.load(cfg.weight)
        #         model.load_state_dict(checkpoint['state_dict'])
        #         self.logger.info("=> loaded weight '{}'".format(cfg.weight))
        # else:
        #     self.logger.info("=> no weight found at '{}'".format(cfg.weight))
