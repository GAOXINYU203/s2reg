...
from geotransformer.modules.transformer.superpoint_class import new_superpoint_label
...
class GeoTransformer(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        ref_class = data_dict['ref_class'].detach()
        src_class = data_dict['src_class'].detach()
        ...
        ref_points_cla = torch.cat((ref_points,ref_class.unsqueeze(1)),dim=1)
        src_points_cla = torch.cat((src_points,src_class.unsqueeze(1)),dim=1)
        ...
        ref_points_c_l = new_superpoint_label(ref_node_knn_points_cla).cuda()
        src_points_c_l = new_superpoint_label(src_node_knn_points_cla).cuda()
        ...
        ref_feats_c, src_feats_c = self.transformer(
            ...
            ref_points_c_l.unsqueeze(0),
            src_points_c_l.unsqueeze(0),
        )
