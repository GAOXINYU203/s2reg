...
class SemanticTransformerLayer(nn.Module):
    def __init__(self, d_model, num_heads, dropout=None, activation_fn='ReLU'):
        super(SemanticTransformerLayer, self).__init__()
        self.attention = SemanticAttentionLayer(d_model, num_heads, dropout=dropout)
