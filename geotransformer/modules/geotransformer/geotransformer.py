...
class GeometricTransformer(nn.Module):
    def __init__(
        ...
        raw_c_neighbor = 133
        self.in_proj_2= nn.Linear(raw_c_neighbor, hidden_dim)
    ...
    def forward(
        ...
        Args:
            ref_points (Tensor): (B, N, 3) 1,227,3
            src_points (Tensor): (B, M, 3)
            ref_feats (Tensor): (B, N, C) 1,227,1024
        ...
        ref_cla_feats = self.in_proj_2(ref_cla)
        src_cla_feats = self.in_proj_2(src_cla)
