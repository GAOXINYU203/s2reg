...
class ThreeDMatchPairDataset(torch.utils.data.Dataset):
    ...
    def _load_point_cloud(self, file_name,datadict):##file_name:'train/rgbd-scenes-v2-scene_01/cloud_bin_2.pth'
        ...
        label = np.load(osp.join(self.label_root, file_name.replace('pth','npy')))
    ...
    def __getitem__(self, index):
        ...
        ref_points ,ref_class  = self._load_point_cloud(metadata['pcd0'],data_dict,)
        src_points ,src_class = self._load_point_cloud(metadata['pcd1'],data_dict,)
